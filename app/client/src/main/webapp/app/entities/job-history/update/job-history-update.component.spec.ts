...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 72494 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 49799 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 54817 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 38908 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 15819 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 70637 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 43526 };
      jobHistory.job = job;
      const department: IDepartment = { id: 94691 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 63598 };
      jobHistory.employee = employee;
