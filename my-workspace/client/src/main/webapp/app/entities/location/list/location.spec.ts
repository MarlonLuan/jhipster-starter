...
describe('Location Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '469e42cb-716b-406a-b8e0-a82cf8e41cdc' }], {
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '469e42cb-716b-406a-b8e0-a82cf8e41cdc' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '469e42cb-716b-406a-b8e0-a82cf8e41cdc' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to locationService', () => {
      ...
      vitest.spyOn(service, 'getLocationIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.locationsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
