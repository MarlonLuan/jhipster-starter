...
describe('Region Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '1ecde3bf-dd1f-4d49-8a3d-4407d415f7b6' }], {
    ...
    expect(comp.regions()[0]).toEqual(expect.objectContaining({ id: '1ecde3bf-dd1f-4d49-8a3d-4407d415f7b6' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '1ecde3bf-dd1f-4d49-8a3d-4407d415f7b6' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '1ecde3bf-dd1f-4d49-8a3d-4407d415f7b6' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to regionService', () => {
      ...
      vitest.spyOn(service, 'getRegionIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.regionsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
